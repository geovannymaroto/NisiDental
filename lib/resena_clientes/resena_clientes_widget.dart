...
import 'resena_clientes_model.dart';
export 'resena_clientes_model.dart';

class ResenaClientesWidget extends StatefulWidget {
  const ResenaClientesWidget({Key? key}) : super(key: key);

  @override
  _ResenaClientesWidgetState createState() => _ResenaClientesWidgetState();
}

class _ResenaClientesWidgetState extends State<ResenaClientesWidget> {
  late ResenaClientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResenaClientesModel());
  }
